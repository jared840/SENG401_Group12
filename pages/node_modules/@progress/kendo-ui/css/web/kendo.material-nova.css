...
.k-progressbar-indeterminate {
  color: rgba(0, 0, 0, 0.87);
  background-color: #f6adc5;
  background-image: linear-gradient(45deg, #e29fb5 25%, transparent 25%, transparent 50%, #e29fb5 50%, #e29fb5 75%, transparent 75%, transparent);
...
.k-radio:checked,
.k-radio.k-checked {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12'%3e%3ccircle cx='50%25' cy='50%25' r='4' fill='%23e51a5f'/%3e%3c/svg%3e");
}
.k-radio:disabled,
.k-radio.k-disabled {
  outline: none;
