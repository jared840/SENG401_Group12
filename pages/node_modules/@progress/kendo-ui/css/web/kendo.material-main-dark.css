...
.k-progressbar-indeterminate {
  color: white;
  background-color: #393c4e;
  background-image: linear-gradient(45deg, #343748 25%, transparent 25%, transparent 50%, #343748 50%, #343748 75%, transparent 75%, transparent);
...
.k-radio:checked,
.k-radio.k-checked {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12'%3e%3ccircle cx='50%25' cy='50%25' r='4' fill='%239fa8da'/%3e%3c/svg%3e");
}
.k-radio:disabled,
.k-radio.k-disabled {
  outline: none;
