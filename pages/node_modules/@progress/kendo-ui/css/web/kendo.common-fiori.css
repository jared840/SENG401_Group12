...
.k-button.k-button-icon {
  width: calc( (1.7142857142857142 * 1em) + (8px * 2) + (1px * 2) );
  height: calc( (1.7142857142857142 * 1em) + (8px * 2) + (1px * 2) );
  padding: 8px;
  gap: 0;
}
...
.k-input-button.k-button {
  width: calc( 1.7142857142857142 * 1em + (8px * 2) );
  height: calc( 1.7142857142857142 * 1em + (8px * 2) );
  border-width: 0;
...
.k-toolbar .k-overflow-anchor {
  margin: 0;
  width: calc( calc( (1.7142857142857142 * 1em) + (8px * 2) + (1px * 2) ) + (4px * 2) );
  height: 100%;
  border-width: 0;
  border-left-width: 1px;
  border-radius: 0;
...
.k-time-list-wrapper {
  ...
  text-align: center;
  min-width: 7em;
  height: calc(7 * (1.71428571 * 1em + 2 * 4px));
}
...
.k-time-highlight {
  ...
  transform: translateY(-50%);
  width: 100%;
  height: calc(1.71428571 * 1em + 8px * 2);
  z-index: 1;
  border-width: 1px 0;
  border-style: solid;
  border-radius: 0.1px;
...
.k-floating-label-container {
  padding-top: calc(1.71428571em * 0.75);
  display: inline-flex;
  vertical-align: middle;
  position: relative;
  width: 100%;
...
.k-floating-label-container > .k-label {
  ...
  text-overflow: ellipsis;
  position: absolute;
  top: calc(calc(1.71428571em * 0.75) + 1px + 8px);
  left: calc(14px + 1px);
  overflow: hidden;
  cursor: text;
...
.k-floating-label-container.k-focus > .k-label {
  transform: translate(calc(-14px), -8px) translate(-1px, calc(-0.75 * 1.71428571em)) translate(-12.5%, -12.5%) scale(0.75);
}
...
.k-floating-label-container[dir='rtl'].k-focus > .k-label {
  transform: translate(calc(14px), calc(-0.75 * 8px)) translate(1px, calc(-0.75 * 1.71428571)) translate(12.5%, calc(-0.75 * 12.5%)) scale(0.75);
}
.k-input-label {
  margin-right: 14px;
  z-index: 1;
...
.k-bottom-nav-item {
  padding: 0px 8px;
  min-width: 72px;
  min-height: calc((16px * 2.5) + (8px * 2));
  border-width: 0;
  border-radius: 4px;
  box-sizing: border-box;
  font: inherit;
...
.k-taskboard-column-new {
  max-height: calc(2.06428571em + (calc(16px / 2) * 2) + 1em);
}
...
.k-flex-row .k-pivotgrid-configurator-overlay {
  right: calc( (1.7142857142857142 * 1em) + (7px * 2) + (1px * 2) );
}
.k-flex-row-reverse .k-pivotgrid-configurator-overlay {
  left: calc( (1.7142857142857142 * 1em) + (7px * 2) + (1px * 2) );
}
.k-flex-col .k-pivotgrid-configurator-overlay {
  bottom: calc( (1.7142857142857142 * 1em) + (7px * 2) + (1px * 2) );
}
.k-flex-col-reverse .k-pivotgrid-configurator-overlay {
  top: calc( (1.7142857142857142 * 1em) + (7px * 2) + (1px * 2) );
}
...
.k-colorpicker .k-selected-color {
  height: calc(1.7142857142857142em + 8px*2);
  width: calc(1.7142857142857142em + 8px*2);
}
.k-colorpicker .k-selected-color .k-i-line {
  line-height: calc(1.7142857142857142em + 8px*2);
  font-size: calc(1.7142857142857142em + 8px*2);
}
.k-grouping-header {
  padding: 0.429em;
}
