...
.k-toolbar .k-overflow-anchor {
  margin: 0;
  width: calc( calc( (1.4285714285714286 * 1em) + (4px * 2) + (1px * 2) ) + (6px * 2) );
  height: 100%;
  border-width: 0;
  border-left-width: 1px;
  border-radius: 0;
...
.k-floating-label-container > .k-label {
  ...
  text-overflow: ellipsis;
  position: absolute;
  top: calc(calc(1.42857143em * 0.75) + 1px + 4px);
  left: calc(8px + 1px);
  overflow: hidden;
  cursor: text;
...
.k-floating-label-container.k-focus > .k-label {
  transform: translate(calc(-8px), -4px) translate(-1px, calc(-0.75 * 1.42857143em)) translate(-12.5%, -12.5%) scale(0.75);
}
...
.k-floating-label-container[dir='rtl'].k-focus > .k-label {
  transform: translate(calc(8px), calc(-0.75 * 4px)) translate(1px, calc(-0.75 * 1.42857143)) translate(12.5%, calc(-0.75 * 12.5%)) scale(0.75);
}
.k-input-label {
  margin-right: 8px;
  z-index: 1;
...
.k-ie9 .k-window-content {
  height: calc( 100% - ((1.25 * 1em) + (12px * 2)) );
  border-radius: 0;
}
