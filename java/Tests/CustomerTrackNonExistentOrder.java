...
public class CustomerTrackNonExistentOrder {
	...
	public void test() {
		...
		HtmlAnchor anchor=page2.getAnchorByHref("TrackOrder.jsp");
...
//System.out.println(page3.getVisibleText());
		...
		final HtmlSubmitInput button2 = login2.getInputByValue("submit");
		final HtmlTextInput textField3 = login2.getInputByName("order_ID");
		
		textField3.type("123456");
		
		final HtmlPage page4 = button2.click();
		WebAssert.assertTextNotPresent(page4, "Your order has shipped!");
		WebAssert.assertTextPresent(page4, "Something went wrong...");
