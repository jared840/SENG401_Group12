...
public class CustomerNoExistSearchTest {
	...
	public void test() {
		...
		textField3.type("TurboGrafx16");
		HtmlPage page4 = button3.click();
		WebAssert.assertTextPresent(page4, "oops...there seems to be no product matching what you're looking for");
