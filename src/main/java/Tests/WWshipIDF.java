...
public class WWshipIDF {
	...
	public void test() {
		...
		HtmlAnchor anchor = page2.getAnchorByHref("shipItems.jsp");
		...
		final HtmlSubmitInput button3 = login2.getInputByValue("Submit");
		final HtmlTextInput textField3 = login2.getInputByName("order_ID");
		textField3.type("2000");
		HtmlPage page4 = button3.click();
WebAssert.assertTextNotPresent(page4, "Success");		
